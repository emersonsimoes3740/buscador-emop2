    ...
    if selecao:
        ...
        if item['comp']:
            ...
            if not mo.empty:
                ...
                st.warning("Este serviço não possui itens de mão-de-obra direta para cálculo.")
...
st.sidebar.markdown("---")
if "token_ativo" in st.session_state:
    st.sidebar.write(f"Conectado: {st.session_state.token_ativo}")
